...
// Función para obtener instructores desde la base de datos para la coordinación "ARTES ESCÉNICAS"
function obtenerInstructores($conexion) {
    $query = "SELECT DISTINCT nom_instructor FROM instructores WHERE coordinacion = 'ARTES ESCÉNICAS'";
...
// Función para contar instructores en la coordinación "ARTES ESCÉNICAS"
function contarInstructores($conexion) {
    $query = "SELECT COUNT(DISTINCT nom_instructor) AS total_instructores FROM instructores WHERE coordinacion = 'ARTES ESCÉNICAS'";
    $result = $conexion->query($query);
        ...
        <div class="encuesta-container">
            <div class="encuesta-box">
                ...
                <div class="total-instructores">
                    <p>Total de Instructores en Artes Escénicas: <?php echo $totalInstructores; ?></p>
                </div>
