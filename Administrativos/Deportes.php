...
// Función para obtener instructores desde la base de datos para la coordinación "Deportes"
function obtenerInstructores($conexion) {
    $query = "SELECT DISTINCT nom_instructor FROM instructores WHERE coordinacion = 'DEPORTES'";
...
// Función para contar instructores en la coordinación "Deportes"
function contarInstructores($conexion) {
    $query = "SELECT COUNT(DISTINCT nom_instructor) AS total_instructores FROM instructores WHERE coordinacion = 'DEPORTES'";
    $result = $conexion->query($query);
        ...
        <div class="encuesta-container">
            <div class="encuesta-box">
                ...
                <div class="total-instructores">
                    <p>Total de Instructores en Deportes: <?php echo $totalInstructores; ?></p>
                </div>
